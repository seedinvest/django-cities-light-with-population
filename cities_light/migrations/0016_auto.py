...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'City', fields ['feature_class']
        db.create_index('cities_light_city', ['feature_class'])

        # Adding index on 'City', fields ['feature_code']
        db.create_index('cities_light_city', ['feature_code'])

        # Adding index on 'City', fields ['population']
        db.create_index('cities_light_city', ['population'])

    def backwards(self, orm):
        # Removing index on 'City', fields ['population']
        db.delete_index('cities_light_city', ['population'])

        # Removing index on 'City', fields ['feature_code']
        db.delete_index('cities_light_city', ['feature_code'])

        # Removing index on 'City', fields ['feature_class']
        db.delete_index('cities_light_city', ['feature_class'])
