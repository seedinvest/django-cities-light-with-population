...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'City_Posting_Entry', fields ['query']
        db.create_unique('cities_light_city_posting_entry', ['query'])

    def backwards(self, orm):
        # Removing unique constraint on 'City_Posting_Entry', fields ['query']
        db.delete_unique('cities_light_city_posting_entry', ['query'])
    ...
    models = {
        ...
        'cities_light.city_posting_entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'query': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200', 'db_index': 'True'})
        },
